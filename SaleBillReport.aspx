<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="SaleBillReport.aspx.cs" Inherits="Flower_Shop.SaleBillReport" %>
                                                ...
                                                <div id="dropzone1" class="pro-ad addcoursepro">                                               
                                                   ...
                                                   <div class="row">
                                                            <div class="form-group col-lg-9">
                                                             ...
                                                             <asp:GridView ID="gv_SaleBillDetail" runat="server" CssClass="table table-bordered table-responsive" AutoGenerateColumns="False"  DataKeyName="BillId" OnRowCommand="gv_SaleBillDetail_RowCommand" OnSelectedIndexChanged="gv_SaleBillDetail_SelectedIndexChanged" DataSourceID="SqlDataSource1" >                                                                                                                     
                                                                    <Columns>
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
