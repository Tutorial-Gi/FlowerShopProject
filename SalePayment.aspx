<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="SalePayment.aspx.cs" Inherits="Flower_Shop.SalePayment" %>
                        ...
                        <div class="row">                                                                                       
                            <div class="form-group col-lg-3">
                                  <asp:Label ID="lbl_CustomerName" runat="server"  Text="Customer Name" Font-Bold="True"></asp:Label>
                                          <asp:DropDownList runat="server" ID="ddl_CustomerName"  AppendDataBoundItems="true"  Class="form-control custom-select-value" OnSelectedIndexChanged="ddl_CustomerName_SelectedIndexChanged" AutoPostBack="true" >
                        ...
                        <div class="sparkline8-list mt-b-30">
                            ...
                            <div class="sparkline8-graph">
                                <div class="basic-login-form-ad">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <asp:GridView ID="gv_SalePayment" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gv_SalePayment_SelectedIndexChanged" CssClass="table table-bordered table-responsive">                                                                                     
