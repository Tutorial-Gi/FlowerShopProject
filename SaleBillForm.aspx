<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="SaleBillForm.aspx.cs" Inherits="Flower_Shop.SaleBillForm" %>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone2" class="pro-ad addcoursepro">
                                                    ...
                                                    <div class="row">
                                                            <div class="form-group col-lg-3">
                                                                <asp:Label ID="lbl_BillNo" Text="Bill No" Font-Bold="true" runat="server"></asp:Label>
                                                                <asp:TextBox ID="txt_BillNo" class="form-control" runat="server" ReadOnly="true"></asp:TextBox>                                                            
                                                            </div>                                                              
                                                           <div class="form-group col-lg-3">
                                                                       <asp:Label ID="lbl_BillDate" runat="server" Text="Bill Date" Font-Bold="true"></asp:Label>
                                                                       <asp:TextBox ID="txt_BillDate" runat="server"  class="form-control" ReadOnly="true" ></asp:TextBox>                                                                   
                                                            </div>
                                                        </div>                                                                                                                                                                                                                          
                                                         <div class="row">                                                             
                                                            <div class="form-group col-lg-3">
                                                        ...
                                                        <hr />                                                                                                                                                                        
                                                        <div class="row">
                                                            <asp:GridView ID="gv_SaleBill" runat="server"  AutoGenerateColumns="False" CssClass="table table-bordered table-responsive">                                                                                     
                                                                    <Columns>                                                                       
